...
The purpose of this project is to show how a junior analyst or IT support professional can receive a user-reported suspicious email, preserve evidence, review headers and links, extract indicators, classify risk, recommend containment, and write clear incident notes.

The project is designed to be realistic, readable, screenshot-friendly, and interview-defensible.
...
- Add one more sample showing credential-entry risk and session revocation steps.
